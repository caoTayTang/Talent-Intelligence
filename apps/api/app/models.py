...
class ChatMessage(Base):
    ...
    sender_role: Mapped[SenderRole] = mapped_column(Enum(SenderRole, name="sender_role"))
...
class Application(Base):
    ...
    cv_object_url: Mapped[str | None] = mapped_column(String)
    dynamic_test_content: Mapped[dict | list | None] = mapped_column(JSONB) # Nội dung đề do AI tự sinh
    test_submission_url: Mapped[list[str] | None] = mapped_column(JSONB) # Link các file nộp bài
    ...
    interview_meeting: Mapped["InterviewSlot" | None] = relationship(back_populates="application")
...
class InterviewSlot(Base):
    ...
    application_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("applications.id"), nullable=True) 
    ...
    application: Mapped["Application"] = relationship(back_populates="interview_meeting")
